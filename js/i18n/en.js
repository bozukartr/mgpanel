...
window.I18N_EN = {
    ...
    'guest.item.groupExtras': 'Extras',
    'guest.item.groupRemovals': 'Remove',
    'guest.item.singleOnly': 'Single item',
    'guest.eta.order': 'Estimated delivery {window}',
    'guest.eta.item': 'Estimated {window}',
    'guest.eta.remaining': '{n} min left',
    'guest.eta.soon': 'Any moment now',
    'guest.eta.delivered': 'Delivered',
    'guest.eta.deliveredAt': 'Delivered · {time}',
    'guest.eta.approx': 'Estimated delivery ~{a}–{b} min',
    'guest.eta.approxOne': 'Estimated delivery ~{n} min',
