...
window.I18N_TR = {
    ...
    'guest.item.groupExtras': 'Ekstralar',
    'guest.item.groupRemovals': 'Çıkarılacaklar',
    'guest.item.singleOnly': 'Tek adet',
    'guest.eta.order': 'Tahmini teslim {window}',
    'guest.eta.item': 'Tahmini {window}',
    'guest.eta.remaining': '{n} dk kaldı',
    'guest.eta.soon': 'Çok yakında',
    'guest.eta.delivered': 'Teslim edildi',
    'guest.eta.deliveredAt': 'Teslim edildi · {time}',
    'guest.eta.approx': 'Tahmini teslim ~{a}–{b} dk',
    'guest.eta.approxOne': 'Tahmini teslim ~{n} dk',
    ...
    'guest.gate.tooMany': 'Çok fazla deneme yapıldı. Lütfen birkaç dakika sonra tekrar deneyin.',
    'guest.gate.ambiguous': 'Kaydınızda birden fazla eşleşme bulundu. Lütfen resepsiyona başvurun.',
    'guest.gate.noRoom': 'Odanız henüz atanmamış görünüyor. Lütfen resepsiyona başvurun.',
