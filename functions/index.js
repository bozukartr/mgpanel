/* Hotizy — Cloud Functions (tek codebase).
 *
 * Kapsam: misafir QR akışı (kimlik doğrulama, sipariş köprüsü, düzenleme/
 * iptal), bildirim fan-out'u, restoran adisyon işlemleri, PMS entegrasyonu,
 * kullanıcı/otel yönetimi ve bakım/göç görevleri.
 *
 * ONLINE ÖDEME KALDIRILDI: PayTR ve Lemon Squeezy entegrasyonları (6 fonksiyon
 * ve ilgili secret'lar) üründen çıkarıldı — abonelik tahsilatı artık çevrim
 * dışı yapılıyor. Operatör superadmin panelinden ödemeyi elle kaydediyor ve
 * abonelik bitiş tarihini elle uzatıyor.
 *
 * Sunucu sırları (istemci koduna asla inmez):
